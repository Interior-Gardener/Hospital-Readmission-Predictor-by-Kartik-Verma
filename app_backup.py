...
def get_user_input():
    ...
    with summary_col1:
        ...
        <p><strong>Hospital Stay:</strong> {} days</p>
        <p><strong>Lab Procedures:</strong> {}</p>
        </div>
        """.format(age, gender, time_in_hospital, num_lab_procedures), unsafe_allow_html=True)
    ...
    with summary_col2:
        ...
        <p><strong>Prior Visits:</strong> {}</p>
        <p><strong>Diagnoses:</strong> {}</p>
        <p><strong>Diabetes Med:</strong> {}</p>
        </div>
        """.format(admission_type_id, number_inpatient, number_diagnoses, diabetesMed), unsafe_allow_html=True)
